...
OK_108 - w edge - no lidar data
OK_117 - w edge - fixed
OK_146 - s edge - fixed
OK_193 - e edge - no lidar data
OK_199 - w edge - no lidar data
OK_228 - e edge - no lidar data
OK_238 - s edge - no lidar data
OK_263 - w edge - no lidar data
OK_265 - nw cnr - fixed
OK_275 - n edge - fixed
OK_293 - n edge - no lidar data
OK_296 - n edge - fixed
OK_320 - ns edges - fixed
OK_336 - w edge - no lidar data
...
j <- which(str_detect(gjsf_elev$summitCode, paste0(x, collapse = "|")))
```
...
which_summit <- 
  which(summit_geometry$summit == "W7W_OK_268")
