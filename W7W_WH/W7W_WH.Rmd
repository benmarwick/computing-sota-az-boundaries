...
# Computing Activation Zone Boundaries for [SOTA](https://www.sota.org.uk/) Summits in W7W-WH 
...
library(rvest)
gjsf <-  httr::GET("https://api2.sota.org.uk/api/regions/W7W/WH") %>% 
...
buffer_side_length <- 8e6 # 100 is a 10x10, this is the value we manually adjust to manage buffer area, to capture the biggest AZ
gjsf_elev_buf <- 
  bSquare(gjsf_elev,
          buffer_side_length)
...
# i <- which(gjsf_elev$summitCode == "W7W/OK-192")
 i <- j[1]
...
which_summit <- 
  which(summit_geometry$summit == "W7W_WH_201")
