...
# Computing Activation Zone Boundaries for [SOTA](https://www.sota.org.uk/) Summits in W7W-ST
...
# need to check
check <- c(
"018",  # Server Error for W7W/ST-018" -> no lidar data
"020", # n edge -> done
"061", # s edge  -> done
"067",  #Server Error for W7W/ST-067" -> done
"071",  # too big  -> done
"072",  # Server Error for W7W/ST-072"  -> no lidar data
"107",  # too big -> done
"117",  # too big -> done
"127", # n and s edges -> done
"147"  # too square
)
...
which_summit <- 
  which(summit_geometry$summit == "W7W_ST_127")
...
Panel of static plots to inspect a batch
