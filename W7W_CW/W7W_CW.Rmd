...
buffer_side_length <- 5e6 # 100 is a 10x10, this is the value we manually adjust to manage buffer area, up to 4e7 to get the biggest AZ
gjsf_elev_buf <- 
...
which_summit <- 
  which(summit_geometry$summit == "W7W_CW_050")
...
CW_013  on the N edge, KG-CH county line
CW_016 on the N edge
CW_017 N and E edges, very large
CW_030 E edge
CW_032 E edge
CW_038 all edges
