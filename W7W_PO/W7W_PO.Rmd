...
# Computing Activation Zone Boundaries for [SOTA](https://www.sota.org.uk/) Summits in W7W-PO
...
# need to check
check <- c(
"006",  # odd middle line -> done
"008",  # odd middle line -> done
"030"   # n edge -> no lidar data
)
